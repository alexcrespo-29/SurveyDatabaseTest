...
map.getView().fit([-8339591.179465, 4829361.111418, -8337387.376372, 4831063.478232], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Survey Database</h2>';
        return titleElement;
    })(),
